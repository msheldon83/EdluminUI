...
export const EmployeeRosterReport: React.FC<{}> = () => {
  ...
  const localStorageKey = "EmployeeRosterReport_20200611";
  const rdl = React.useMemo(() => {
    ...
    return "QUERY FROM Employee WHERE (Active = '1') SELECT Concat(LastName,', ',FirstName) AS Employee WIDTH(250), ExternalId, Active, InvitationStatus, LocationNames, Title WIDTH(250), PositionTypeName, Email, LoginEmail ORDER BY Concat(LastName,', ',FirstName) ASC";
  }, []);
