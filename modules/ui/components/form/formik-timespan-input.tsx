...
export const FormikTimespanInput: React.FC<Props> = props => {
  ...
  useEffect(() => {
    ...
    if (isBefore(parseISO(endTimeField.value), parseISO(startTimeField.value)))
  ...
  const renderReversedTimesInfo = () => {
    if (!props.permitReversedTimes || warningConfirmed || !showWarning)
      return <></>;
    ...
    return (
      <div className={classes.warningMessageContainer}>
        <div className={classes.warningMessage}>
          <TextButton
            onClick={() => onWarningConfirmedClick()}
